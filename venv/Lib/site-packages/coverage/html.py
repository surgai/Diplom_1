...
class HtmlReporter:
    ...
    def make_local_static_report_files(self) -> None:
        ...
        # Only write the _gitignore file if the directory was originally empty.
        # _gitignore can't be copied from the source tree because it would
        # prevent the static files from being checked in.
        if self.directory_was_empty:
            with open(os.path.join(self.directory, "_gitignore"), "w") as fgi:
